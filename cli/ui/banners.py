...
def print_banner() -> None:
    ...
    logo_art = """
   ____ _____ __  __ ___ _   _ ___       _    ____ ___ 
  / ___| ____|  \/  |_ _| \ | |_ _|     / \  |  _ \_ _|
 | |  _|  _| | |\/| || ||  \| || |     / _ \ | |_) | | 
 | |_| | |___| |  | || || |\  || |    / ___ \|  __/| | 
  \____|_____|_|  |_|___|_| \_|___|  /_/   \_\_|  |___|
"""
    ...
    console.print()
    # Responsive banner: compact title on small windows, full ASCII on normal/wide windows
    if term_width >= 58:
        console.print(Text(logo_art, style="bold cyan"))
    else:
        compact_title = Text()
        compact_title.append("=== ", style="bold cyan")
        compact_title.append("GEMINI-API", style="bold white")
        compact_title.append(" ===", style="bold cyan")
        console.print(compact_title)

    header_info = Text()
    header_info.append("  GEMINI-API ", style="bold white")
    ...
    header_info.append(" for commands\n", style="dim")
    ...
    card_text.append("/load", style="bold white")
    card_text.append(" (resume chat) | ", style="dim")
